\begin{UseCase}{CUD13}{Eliminar Paciente}
    {
    	Este caso de uso permite al \textbf{Doctor} eliminar un paciente en caso de que el actor ya no tenga ningún tratamiento médico en estado \textbf{incompleto}. 
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Doctor}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Eliminar Paciente}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Eliminar paciente.}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{\begin{UClist} 
			\UCli \cdtIdRef{MSG}{Eliminar Elemento}: Se muestra en la pantalla \textbf{Auxiliares} cuando el actor solicita eliminar un paciente.
			\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Gestión Pacientes} cuando se eliminó el paciente de manera exitosa.
	\end{UClist}}
	\UCitem{Precondiciones}{
		{\bf Interna:} Debe de existir un paciente 
	}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Eliminará el paciente de la cuenta del doctor.	
	}
...
\begin{UCtrayectoria}
	...
	\UCpaso [\UCactor] Presiona el ícono \textbf{Eliminar paciente} asociado al paciente que desea eliminar en la pantalla \textbf{Gestión Pacientes}.
	\UCpaso Muestra el mensaje \cdtIdRef{MSG22}{Eliminar Elemento} en la pantalla \textbf{Gestión Pacientes}.
%	\cdtIdRef{IUP22}{Consultar Auxiliar}.
	\UCpaso [\UCactor] Confirma eliminar el paciente a través del botón \textbf{Eliminar}. \refTray{A}
	\UCpaso Elimina el paciente de la aplicación.
	\UCpaso Muestra el mensaje \textbf{MSG1 Operación Exitosa} en la pantalla \textbf{Gestión Pacientes}
%	 \cdtIdRef{IUP22}{Consultar Auxiliar}.
...
\begin{UCtrayectoriaA}{A}{El actor desea cancelar la operación.}
	...
	\UCpaso Muestra a la pantalla \textbf{Gestión Pacientes}
%	\cdtIdRef{IUP22}{Consultar Auxiliar}.
\end{UCtrayectoriaA}
