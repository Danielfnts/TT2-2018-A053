\begin{UseCase}{CUD15}{Consultar Historial Clínico}
    {
    	Un doctor podrá consultar la información del historial clínico de un paciente, en donde se mostrarán los tratamientos médicos que se han recetado a ese paciente.
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Doctor}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Consulta de historial clínico}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar historial clínico}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{
		\begin{UClist}
			\UCli Nombre del tratamiento
			\UCli Fecha de expedición.
%			\UCli Estado del tratamiento.
%			\UCli Semana en la que se encuentra.
			\UCli Medicamentos del tratamiento
%			\UCli Tratamientos previamente registrados.
		\end{UClist}
	}
	\UCitem{Precondiciones}{
		{\bf Interna:} Que exista el tratamiento al que se está accediendo.
%		{\bf Interna:} Que el tratamiento al que se está accediendo esté en estado activo.
...
% 	\UCpaso	Obtiene el estado del tratamiento. 
 	...
 	\UCpaso [\UCactor] Da clic en el botón Consultar historial clínico
 	\UCpaso Muestra la pantalla \textbf{Consultar Historial Clínico}
 	
% 	\cdtIdRef{IUP8}{Consultar Información del Tratamiento}.
