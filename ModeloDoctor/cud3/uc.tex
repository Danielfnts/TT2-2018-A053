\begin{UseCase}{CUD2}{Registro de Cuenta}
    {
...
%--------------------------------------------------------
	...
	\UCitem{Mensajes}{
		...
		\UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \cdtIdRef{IUP3}{Registro de Cuenta} cuando el actor omitió un dato marcado como requerido.
 ...
 \begin{UCtrayectoria}
	 ...
	 \UCpaso Muestra la pantalla \cdtIdRef{IUP3}{Registro de Cuenta}.
	 ...
	 \UCpaso [\UCactor] Presiona el botón \cdtButton{Obtener numero} \refTray{A}
	 ...
	 \UCpaso [\UCactor] Da clic en el icono \textbf{Tomar foto}. \refTray{E}
	 \UCpaso Muestra el mensaje \cdtIdRef{MSG5}{Obtener datos} en la pantalla \textbf{Creación de cuenta fotografia}.
	 \UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar} del mensaje.
	 ...
	 \UCpaso Muestra el mensaje \cdtIdRef{MSG1}{Operación Exitosa} en la pantalla \cdtIdRef{IUP1}{Iniciar Sesión}.
 ...
 \begin{UCtrayectoriaA}{B}{El actor tendrá un rol que requiere un dato extra.}
 	...
 	\UCpaso Muestra la casilla \textbf{Cédula profesional} en la pantalla \cdtIdRef{IUP3}{Registro de Cuenta}.
...
\begin{UCtrayectoriaA}{D}{El actor no ingreso la contraseña de forma correcta.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Faltan datos en la contraseña} en la pantalla \cdtIdRef{IUP3}{Registro de Cuenta}
	\UCpaso[] Continúa en el paso \ref{cur5:Celular} de la trayectoria principal.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{E}{El actor no quiere tomar una foto.}
	...
	\UCpaso Muestra el mensaje \cdtIdRef{MSG5}{Obtener datos} en la pantalla \cdtIdRef{IUP3-1}{Registro de Cuenta} la primera vez que esto sucede.
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar} del mensaje.
