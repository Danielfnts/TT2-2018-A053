\subsection{IUD10 Agregar Tratamiento}
...
\subsubsection{Diseño}
    ...
    En la figura \ref{IUP10} se muestra la pantalla ``Agregar Nuevo Tratamiento'', por medio de la cual se podrá agregar un nuevo tratamiento médico a la aplicación. \\

    \IUfig[.3]{pantallas/agregarTratamientoD}{IUD10}{Agregar Tratamiento}
