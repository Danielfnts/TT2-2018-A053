\begin{UseCase}{CUD10}{Agregar Tratamiento a Paciente Nuevo}
    {
   		Este caso de uso permite al \textbf{Doctor} ingresar los datos de un tratamiento nuevo a un Paciente que ya esté asociado con su cuenta.
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Doctor}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Agregar Tratamiento a Paciente.}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Agregar Tratamiento a Paciente Nuevo.}
	\UCitem{Entradas}{
		\begin{UClist} 
