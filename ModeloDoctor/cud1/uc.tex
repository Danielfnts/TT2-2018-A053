\begin{UseCase}{CUD1}{Iniciar Sesión}
    {
...
%--------------------------------------------------------
	...
	\UCitem{Mensajes}{
		...
		\UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \cdtIdRef{IUP1}{Iniciar sesión} cuando el actor omitió un dato marcado como requerido.
		\UCli \cdtIdRef{MSG3}{Nombre de usuario y/o contraseña incorrecto}: Se muestra en la pantalla \textbf{Iniciar sesión} indicando que el correo electrónico y/o contraseña son incorrectos.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Ingresa correo electrónico y contraseña.\label{cur1:Acciones}
% 	\UCpaso [\UCactor] Selecciona el checkbox de \textbf{Mantener Sesión Abierta}.
 	...
 	\UCpaso[\UCsist] Muestra la pantalla \textbf{Menú Principal} con las acciones de su rol.
 	
    
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no ingresó alguno de los datos requeridos.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada} en la pantalla \cdtIdRef{IUP1}{Iniciar sesión}
 ...
 \begin{UCtrayectoriaA}{B}{No se encontró una cuenta con el nombre de usuario ingresado.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Nombre de usuario y/o contraseña incorrecto} en la pantalla \cdtIdRef{IUP1}{Iniciar sesión}.
 ...
 \begin{UCtrayectoriaA}{C}{El actor ingresó una contraseña que no coincide con la registrada en el sistema.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Nombre de usuario y/o contraseña incorrecto} en la pantalla \cdtIdRef{IUP1}{Iniciar sesión} indicando que el usuario y/o contraseña son incorrectos.
    \UCpaso[] Continúa con el paso \ref{cur1:Acciones} de la trayectoria principal.
 \end{UCtrayectoriaA} 
...
{\cdtIdRef{CUD 2}{Recuperar contraseña}}

\UCExtensionPoint
{El actor requiere crear una cuenta}
{ Paso \ref{cur1:Acciones} de la trayectoria principal}
{\cdtIdRef{CUD 3}{Registro de cuenta}}
