\subsection{IUD6 Consultar Tratamiento de Pacientes}
...
\subsubsection{Diseño}
    ...
    En la figura \ref{IUD6} se muestra la pantalla ``Consultar Tratamientos'', por medio de la cual se podrán consultar los tratamientos registrados en el sistema. \\

    \IUfig[.3]{pantallas/consultarTratamientoP}{IUD6}{Consultar Tratamiento de Pacientes}
