\begin{UseCase}{CUD5}{Consultar Pacientes}
    {
    	Un doctor contará con la facultad de consultar los pacientes de los cuales son o fueron responsables de sus tratamientos y así poder tener un conocimiento de éstos. 
    ...
    \UCitem{Operación}{Consulta de paciente}
    \UCccitem{Prioridad}{Alta}
    \UCccitem{Complejidad}{Baja}
    \UCccitem{Volatilidad}{Baja}
    \UCccitem{Madurez}{Alta}
    \UCitem{Estatus}{Terminado}
    \UCitem{Fecha del último estatus}{09 de Octubre del 2019}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar los pacientes que se tienen asociados a la cuenta del Doctor.}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{\begin{UClist} 
			\UCli Nombre de paciente.
			\UCli Nombre de tratamiento del paciente del que es responsable.
		\end{UClist}}
 ...
 \begin{UCtrayectoria}
	 ...
	 \UCpaso [\UCactor] Presiona el ícono \textbf{Consultar Pacientes} en la pantalla \textbf{Gestión Paciente}.
	 
	 \UCpaso Verifica que el doctor cuente con pacientes agregados a su usuario.\refTray{A}
	 
	 \UCpaso Obtiene el nombre de los pacientes registrados en la aplicación.
	 
	 \UCpaso Obtiene la fotografía de los pacientes.
	 
	 \UCpaso Obtiene los tratamientos que se expidieron a esos pacientes.
	 
	 \UCpaso Ordena a los pacientes por su nombre de manera ascendente.
	 
	 \UCpaso Muestra la pantalla \textbf{Consultar Paciente}
%	 \cdtIdRef{IUP15}{Consultar Doctor}. \label{acciones}
	 
	 
   
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no tiene pacientes asociados a su cuenta.}
    
   	\UCpaso Muestra el mensaje \textbf{MSG No hay Pacientes} en la pantalla \textbf{Gestión Paciente}.
%   	\cdtIdRef{MSG18}{No hay Doctores} en la pantalla \textbf{Gestión Doctor}.
    
    \UCpaso [\UCactor] Presiona el botón \cdtButton{Agregar Paciente} del mensaje {MSG}{No hay Pacientes}. \refTray{B} 
    
    \UCpaso Extiende al caso de uso \cdtIdRef{CUD10}{Agregar Paciente Nuevo}. \label{agregar}
   
 
\end{UCtrayectoriaA}

\begin{UCtrayectoriaA}{B}{El actor no quiere agregar un paciente}
	
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Cancelar} del mensaje {MSG}{No hay Pacientes}.
...
\UCExtensionPoint
{El actor requiere registrar un nuevo paciente}
{ Paso \ref{agregar} de la trayectoria principal}
{\cdtIdRef{CUD10}{Agregar Paciente Nuevo}}


\UCExtensionPoint
{El actor requiere editar un paciente}
{ Paso \ref{acciones} de la trayectoria principal}
{\cdtIdRef{CUD13}{Editar Paciente}}
 
 
\UCExtensionPoint
{El actor requiere eliminar un paciente}
{ Paso \ref{acciones} de la trayectoria principal}
{\cdtIdRef{CUD14}{Eliminar Paciente}}
