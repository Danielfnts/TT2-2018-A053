\begin{UseCase}{CUD4}{Editar Datos Personales}
    {

    	Los datos al pasar el tiempo son flexibles al cambio, esto quiere decir que un usuario que inicialmente sólo tenía un rol, ahora puede tener uno ó dos mas.
    ...
    \UCitem{Operación}{Editar datos personales}
...
%--------------------------------------------------------
	...
	\UCitem{Mensajes}{
		...
		\UCli \cdtIdRef{MSG12}{Cédula profesional no válida} 
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Da clic sobre el ícono de \textbf{Editar} en la pantalla \cdtIdRef{IUP4}{Datos Personales}.
% 	\UCpaso Deshabilita el ícono \textbf{Contactos de Emergencia}.
 	\UCpaso Se habilitan las casillas que son modificables. 	
 	\UCpaso [\UCactor] Da clic en el ícono \textbf{Tomar foto}. \refTray{A}
...
%	\UCpaso Verifica que los datos ingresados por el usuario sean correctos como lo indica la regla de negocio \cdtIdRef{RN1}{Información correcta}. \refTray{F}
%	\UCpaso Verifica que el usuario tenga por lo menos un rol como lo indica la regla de negocio \cdtIdRef{RN4}{Roles existentes}. \refTray{G}.
%	\UCpaso Verifica que la cédula profesional ingresada esté como lo indica la regla de negocio \cdtIdRef{RN4}{Roles existentes}. \refTray{H}.
%	\UCpaso Actualiza los datos del usuario.
%	\UCpaso Muestra el mensaje \cdtIdRef{MSG1}{Operación Exitosa} en la pantalla \textbf{Consultar datos personales}.
%\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{C}{El actor no desea cambiar de correo electrónico}
	...
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Guardar cambios}.\refTray{D}
	\UCpaso Verifica que los datos ingresados por el usuario sean correctos como lo indica la regla de negocio \cdtIdRef{RN1}{Información correcta}. \refTray{F}
	\UCpaso Verifica que el usuario tenga por lo menos un rol como lo indica la regla de negocio \cdtIdRef{RN4}{Roles existentes}. \refTray{E}.
	\UCpaso Actualiza los datos del usuario.
	\UCpaso Muestra el mensaje \cdtIdRef{MSG1}{Operación Exitosa} en la pantalla \textbf{Consultar datos personales}.
\end{UCtrayectoriaA}
...
\begin{UCtrayectoriaA}{E}{El actor no ingresó alguno de los datos requeridos.}
