\begin{UseCase}{CUD2}{Recuperar Contraseña}
    {
    	En el momento en que un usuario de la aplicación no puede ingresar al sistema por que olvidó su contraseña o no está ingresando la contraseña correcta, la aplicación podrá recuperar su contraseña cuando el usuario proporcione su correo electrónico o su número celular.
...
%--------------------------------------------------------
	...
	\UCitem{Entradas}{
		...
		\textbf{Número Celular}: \ioEscribir.
}
	...
	\UCitem{Postcondiciones}{
	    {\bf Interna:} El actor recuperará su contraseña
	}
	...
	\UCitem{Mensajes}{
	    ...
	    \UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Recuperar contraseña} cuando se mando el correo para recuperar la contraseña.
		\UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \cdtIdRef{IUP2}{Recuperar Contraseña} cuando el actor omitió un dato marcado como requerido.
		\UCli \cdtIdRef{MSG4}{Correo electrónico no existente}: Se muestra en la pantalla \cdtIdRef{IUP2}{Recuperar Contraseña} indicando que el correo electrónico ingresado no existe.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP2}{Recuperar Contraseña}.
	...
	\UCpaso Muestra el mensaje \cdtIdRef{MSG1}{Operación Exitosa} en la pantalla \cdtIdRef{IUP2}{Recuperar Contraseña} 
 ...
 \begin{UCtrayectoriaA}{A}{El actor no ingresó alguno de los datos requeridos.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada} en la pantalla \cdtIdRef{IUP2}{Recuperar Contraseña}
 ...
 \begin{UCtrayectoriaA}{B}{No se encontró una cuenta con el correo ingresado.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG4}{correo electrónico no existente} en la pantalla \cdtIdRef{IUP2}{Recuperar Contraseña}.
