\begin{UseCase}{CUD7}{Editar Tratamiento de Pacientes}
    {
    	Un tratamiento en estado \textbf{Incompleto} puede ser editado en el caso que se necesiten agregar nuevos medicamentos o quitar los medicamentos ya existentes.
    ...
    \UCitem{Operación}{Editar Tratamiento de Pacientes}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Editar tratamiento del Paciente}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{Ninguna.}
	\UCitem{Precondiciones}{
		{\bf Interna:} El tratamiento debe de estár en estado \textbf{Incompleto}.
		}
...
% 	\cdtIdRef{IUP7}{Consultar Tratamiento}.
 	...
 	\UCpaso [\UCactor] Da clic en el botón \textbf{Editar Tratamiento}.
 	\UCpaso Muestra la pantalla \textbf{Editar Tratamiento}.
 	\UCpaso [\UCactor] Edita la información necesaria del tratamiento.
% 	\cdtIdRef{IUP9}{Editar Tratamiento}.\label{cur10:medicamentos}
...
%
%\UCExtensionPoint
%{El actor requiere agregar un medicamento}
