\begin{UseCase}{CUD12}{Editar Paciente}
    {
    	Este caso de uso permite al \textbf{Doctor} editar los datos de un Paciente en caso de que haya registrado un dato incorrecto o desee actualizar su teléfono o correo electrónico.
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Doctor}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Editar Paciente}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Editar Paciente.}
	\UCitem{Entradas}{
        \begin{UClist} 
...
%        	\UCli \textbf{Tratamientos}: Se seleccionan de una lista de checkbox.
	...
	\UCitem{Salidas}{\begin{UClist} 
			\UCli Nombre del paciente.
			\UCli Apellido paterno del paciente.
			\UCli Apellido materno del paciente.
			\UCli Teléfono del paciente.
			\UCli Correo electrónico del paciente.
			\UCli Tratamientos del paciente.
			
	\end{UClist}}
	\UCitem{Precondiciones}{Ninguna.}
	\UCitem{Postcondiciones}{
	     {\bf Interna:} Actualizara los datos del paciente en la aplicación.	
	}
	...
	\UCitem{Mensajes}{
	    ...
	    \UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Gestión Pacientes} cuando se agregó el paciente de manera exitosa.
	    \UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \textbf{Editar paciente} cuando el actor omitió un dato marcado como requerido.
	    \UCli \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecto}: Se muestra en la pantalla \textbf{Editar paciente} indicando que el correo electrónico y/o contraseña son incorrectos.
...
%  \cdtIdRef{IUP21}{Editar Auxiliar}.
...
\begin{UCtrayectoriaA}{B}{El actor no ingresó un dato requerido.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada} en la pantalla \textbf{Editar Paciente}.
...
\begin{UCtrayectoriaA}{C}{El actor ingresó un correo electrónico y/o contraseña con un formato incorrecto.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecta} en la pantalla \textbf{Editar Paciente} indicando que el usuario y/o contraseña son incorrectos.
	\UCpaso Continúa con el paso 3 de la trayectoria principal.
\end{UCtrayectoriaA} 
