\begin{UseCase}{CUP7}{Consultar Información de Tratamiento}
    {
    ...
    \UCitem{Operación}{Consulta de información de tratamiento}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar la Información de los tratamientos}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Selecciona un \textbf{Tratamiento} con estado \textbf{Activo} de la pantalla \cdtIdRef{IUP7}{Consultar Tratamiento}.
 	...
 	\UCpaso	Muestra la pantalla \cdtIdRef{IUP8}{Consultar Información del Tratamiento}.
