\begin{UseCase}{CUP8}{Editar Tratamiento}
    {
    	Un tratamiento en estado \textbf{Incompleto} le muestra al paciente que hace falta que se le agreguen medicinas para que esté completo y pueda pasar a estado \textbf{Activo}.
...
%--------------------------------------------------------
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Selecciona un \textbf{Tratamiento} con estado \textbf{Incompleto} de la pantalla \cdtIdRef{IUP7}{Consultar Tratamiento}.
 	...
 	\UCpaso	Muestra la pantalla \cdtIdRef{IUP9}{Editar Tratamiento}.\label{cur10:medicamentos}
