\begin{UseCase}{CUP16}{Editar Auxiliar}
    {
    	Este caso de uso permite al \textbf{Paciente} editar los datos de un Auxiliar en caso de que haya registrado un dato incorrecto o desee actualizar su teléfono o correo electrónico.
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Salidas}{\begin{UClist} 
			...
			\UCli Tratamientos de los que se encarga el auxiliar.
			
	\end{UClist}}
	\UCitem{Precondiciones}{Ninguna.}
	\UCitem{Postcondiciones}{
	     {\bf Interna:} Actualizara los datos del Auxiliar en la aplicación.	
	}
	...
	\UCitem{Mensajes}{
	    ...
	    \UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \textbf{Editar Auxiliar} cuando el actor omitió un dato marcado como requerido.
	    \UCli \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecto}: Se muestra en la pantalla \textbf{Editar Auxiliar} indicando que el correo electrónico y/o contraseña son incorrectos.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el ícono \textbf{Editar Auxiliar} asociado al auxiliar que desea editar en la pantalla \cdtIdRef{IUP22}{Consultar Auxiliar}.
 	\UCpaso Muestra la pantalla \textbf{Editar Auxiliar}.
 	\UCpaso [\UCactor] Edita la información que deseas editar en la pantalla \cdtIdRef{IUP21}{Editar Auxiliar}.
 	...
 	\UCpaso Muestra el mensaje \textbf{MSG1 Operación Exitosa} en la pantalla \cdtIdRef{IUP22}{Consultar Auxiliar}.
...
\begin{UCtrayectoriaA}{B}{El actor no ingresó un dato requerido.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operaciónn solicitada} en la pantalla \textbf{Editar Auxiliar}.
...
\begin{UCtrayectoriaA}{C}{El actor ingresó un correo electrónico y/o contraseña con un formato incorrecto.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecta} en la pantalla \textbf{Editar Auxiliar} indicando que el usuario y/o contraseña son incorrectos.
	\UCpaso Continúa con el paso 3 de la trayectoria principal.
\end{UCtrayectoriaA} 
