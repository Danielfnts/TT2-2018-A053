\subsection{IUP17 Consultar Auxiliar}
 
\subsubsection{Objetivo}

    Esta pantalla permite al actor consultar los auxiliares que tiene registrados en su cuenta dentro de la aplicación

\subsubsection{Diseño}

    En la figura \ref{IUP22} se muestra la pantalla ``Auxiliares'', por medio de la cual se podrá consultar los auxiliares que se encuentran registrados. \\

    \IUfig[.3]{pantallas/consultarAuxiliar}{IUP17}{Consultar Auxiliar}
