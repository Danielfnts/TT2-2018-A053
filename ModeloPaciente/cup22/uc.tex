\begin{UseCase}{CUP17}{Consultar Auxiliar}
    {
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar auxiliares.}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{\begin{UClist} 
			\UCli Nombre de auxiliar.
			\UCli Teléfono de auxiliar.
			\UCli Correo de auxiliar.
			\UCli Tratamientos
	\end{UClist}}
	\UCitem{Precondiciones}{
		{\bf Interna:} Deben de existir auxiliares asociados al paciente.
		}
...
\begin{UCtrayectoria}
	...
	\UCpaso [\UCactor] Presiona el ícono \textbf{Consultar Auxiliar} en la pantalla \textbf{Gestión Auxiliares}.
	
	\UCpaso Verifica que haya auxiliares agregados al usuario.\refTray{A}
	
	\UCpaso Obtiene el nombre del auxiliar.
	
	\UCpaso Obtiene el número celular del auxiliar.
	
	\UCpaso Obtiene el correo electrónico del auxiliar.
	
	\UCpaso Obtiene los tratamientos de los que se encarga el auxiliar.
	
	\UCpaso  Muestra la pantalla \cdtIdRef{IUP22}{Consultar Auxiliar}. \label{acciones}
...
\begin{UCtrayectoriaA}{A}{El actor no tiene auxiliares asociados a su cuenta.}
	\UCpaso Muestra el mensaje \cdtIdRef{MSG21}{No hay auxiliares} en la pantalla \textbf{Auxiliar}.
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar} del mensaje {MSG21}{No hay auxiliares}.
...
{\cdtIdRef{CUP21}{Editar Auxiliar}}

\UCExtensionPoint
{El actor requiere eliminar un auxiliar}
{ Paso \ref{acciones} de la trayectoria principal}
{\cdtIdRef{CUP23}{Eliminar Auxiliar}}
