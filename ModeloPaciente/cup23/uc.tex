\begin{UseCase}{CUP18}{Eliminar Auxiliar}
    {
    	Este caso de uso permite al \textbf{Paciente} eliminar un auxiliar en caso de que el actor ya no necesite un auxiliar que lo esté apoyando con el proceso de su tratamiento médico. 
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Paciente}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Eliminar Auxiliar}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Eliminar auxiliar.}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{\begin{UClist} 
			\UCli \cdtIdRef{MSG}{Eliminar Elemento}: Se muestra en la pantalla \textbf{Auxiliares} cuando el actor solicita eliminar un auxiliar.
			\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Auxiliares} cuando se eliminó el auxiliar de manera exitosa.
	\end{UClist}}
	\UCitem{Precondiciones}{
		{\bf Interna:} Debe de existir un auxiliar agregado al paciente.
	}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Eliminará el auxiliar de la cuenta del paciente.	
	}
...
\begin{UCtrayectoria}
	...
	\UCpaso [\UCactor] Presiona el ícono \textbf{Eliminar Auxiliar} asociado al Auxiliar que desea eliminar en la pantalla \textbf{Consulta de Auxiliares}.
	\UCpaso Muestra el mensaje \cdtIdRef{MSG22}{Eliminar Elemento} en la pantalla \cdtIdRef{IUP22}{Consultar Auxiliar}.
	\UCpaso [\UCactor] Confirma eliminar el auxiliar a través del botón \textbf{Eliminar}. \refTray{A}
	\UCpaso Elimina el auxiliar de la aplicación.
...
\begin{UCtrayectoriaA}{A}{El actor desea cancelar la operación.}
	...
	\UCpaso Muestra a la pantalla \cdtIdRef{IUP22}{Consultar Auxiliar}.
\end{UCtrayectoriaA}
