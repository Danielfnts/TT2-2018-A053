\begin{UseCase}{CUP13}{Recibir Recordatorios}
    {
    ...
    \UCitem{Postcondiciones}{
    	{\bf Interna:} Se contará la toma del medicamento en el tratamiento.	
    }
...
\UCpaso Muestra la pantalla \cdtIdRef{IUP16}{Recibir Notificación}.
...
\UCpaso Muestra el mensaje \cdtIdRef{MSG19}{Toma realizada}.
...
\begin{UCtrayectoriaA}{A}{El actor no tomará el medicamento en ese momento.}
