\subsection{IUP13 Recibir Recordatorios}
...
\subsubsection{Diseño}
    ...
    En la figura \ref{IUP16} se muestra la pantalla ``Recordatorio'', por medio de la cual se recibirán las notificaciones configuradas en el tratamiento médico. \\

    \IUfig[.3]{pantallas/recibirNotificacion}{IUP13}{Recibir Recordatorios}
