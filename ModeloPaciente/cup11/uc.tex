\begin{UseCase}{CUP10}{Agregar Medicamento}
	{
...
%		Los medicamentos son la parte medular de un tratamiento, son los que 
	...
	\UCitem{Postcondiciones}{
		{\bf Interna:} La medicina se agregará al tratamiento.	
	}
	...
	\UCitem{Mensajes}{
		\begin{UClist}
			\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Iniciar sesión} cuando se agrego el medicamento de manera exitosa.	
...
\begin{UCtrayectoria}
	...
	\UCpaso Muestra la pantalla \cdtIdRef{IUP11}{Agregar Medicamento}
	...
	\UCpaso [\UCactor] Selecciona la opción \textbf{¿Ya compraste el medicamento?}. \refTray{B} \label{medicamentono}
	\UCpaso Muestra la pantalla \cdtIdRef{IUP11}{Agregar Medicamento}.
...
\begin{UCtrayectoriaA}{B}{El paciente no ha comprado el medicamento}
	...
	\UCpaso Muestra el mensaje \cdtIdRef{MSG14}{Medicamento agregado pero incompleto} en la pantalla.
	\UCpaso Extiende al caso de uso \cdtIdRef{CUP9}{Editar Tratamiento}
\end{UCtrayectoriaA}
...
{\cdtIdRef{CUP9}{Editar Tratamiento}}