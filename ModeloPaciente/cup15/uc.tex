\begin{UseCase}{CUP12}{Consultar Doctor}
    {
    	Un paciente contará con la facultad de consultar los doctores que son o fueron responsables de sus tratamientos y así poder tener un conocimiento de éstos. 
    ...
    \UCitem{Operación}{Consulta de doctor}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar los doctores que se tienen asociados a la cuenta del Paciente.}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{\begin{UClist} 
			\UCli Nombre de doctor.
			\UCli Nombre de tratamiento del que es responsable.
		\end{UClist}}
 ...
 \begin{UCtrayectoria}
	 ...
	 \UCpaso [\UCactor] Presiona el ícono \textbf{Consultar Doctores} en la pantalla \textbf{Gestión Doctor}.
	 
	 \UCpaso Verifica que el paciente cuente con doctores agregados a su usuario.\refTray{A}
	 
	 \UCpaso Obtiene el nombre de los doctores registrados en la aplicación.
	 
	 \UCpaso Obtiene la fotografía de los doctores.
	 
	 \UCpaso Obtiene los tratamientos que expidieron los doctores.
	 
	 \UCpaso Ordena a los doctores por su nombre de manera ascendente.
	 
	 \UCpaso Muestra la pantalla \cdtIdRef{IUP15}{Consultar Doctor}. \label{acciones}
	 
	 
   
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no tiene doctores asociados a su cuenta.}
    
   	\UCpaso Muestra el mensaje \cdtIdRef{MSG18}{No hay Doctores} en la pantalla \textbf{Gestión Doctor}.
    
    \UCpaso [\UCactor] Presiona el botón \cdtButton{Agregar doctor} del mensaje {MSG18}{No hay Doctores}. \refTray{B} 
    
    \UCpaso Extiende al caso de uso \cdtIdRef{CUP12}{Agregar Doctor}. \label{agregar}
...
\begin{UCtrayectoriaA}{B}{El actor no quiere agregar un doctor}
	...
	\UCpaso [\UCactor] Presiona el botón \cdtButton{Cancelar} del mensaje {MSG18}{No hay Doctores}.
