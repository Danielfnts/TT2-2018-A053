\subsection{IUP12 Consultar Doctor}
 
\subsubsection{Objetivo}

    Esta pantalla permite al actor consultar los doctores que tiene registrados en la aplicación.

\subsubsection{Diseño}

    En la figura \ref{IUP15} se muestra la pantalla ``Doctors'', por medio de la cual se podrá consultar los doctores que se tienen registrados. \\

    \IUfig[.3]{pantallas/consultarDoctor}{IUP12}{Consultar Doctor}
