\begin{UseCase}{CUP5}{Cambiar Contraseña}
    {
...
%--------------------------------------------------------
    ...
    \UCitem{Reglas de negocio}{
            ...
            \cdtIdRef{RN10}{Formato de Contraseña Incorrecto}:Verifica que la contraseña cumpla con el formato correcto.
            
            \cdtIdRef{RN11}{Confirmación de Contraseña Incorrecta}: Verifica que la contraseña coincida con la confirmación de contraseña:
    }
	\UCitem{Mensajes}{
	    \begin{UClist}
	    	
	    \UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \cdtIdRef{IUP4}{Datos Personales} cuando se cambió la contraseña de manera exitosa.
	    \UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \cdtIdRef{IUP4}{Datos Personales} cuando el actor omitió un dato marcado como requerido.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el botón \textbf{Cambiar Contraseña} de la pantalla \cdtIdRef{IUP5}{Editar Datos Personales}.
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP6}{Cambiar Contraseña}.
% 	\UCpaso [\UCactor] Ingresa la Contraseña Anterior . \label{contra}
 	...
 	\UCpaso [\UCactor] Presiona el botón \textbf{Cambiar contraseña} en la pantalla  \cdtIdRef{IUP6}{Cambiar Contraseña}.
 	\UCpaso Verifica que todos los datos requeridos sean proporcionados con base a la regla de negocio \cdtIdRef{RN9}{Datos Requeridos}.
 	\UCpaso Verifica que las contraseñas cumplan con el formato correcto con base en la regla de negocio \cdtIdRef{RN10}{Formato de Contraseña Incorrecto}.
 	\UCpaso Verifica que la contraseña nueva coincida con la confirmación de la contraseña con base a la regla de negocio \cdtIdRef{RN11}{Confirmación de Contraseña Incorrecta}
 ...
 \begin{UCtrayectoriaA}{A}{El actor desea cancelar la operación.}
 	\UCpaso [\UCactor] Da clic en el botón \textbf{Cancelar} de la pantalla \cdtIdRef{IUP6}{Cambiar Contraseña}.
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP5}{Editar Datos Personales}.
...
\begin{UCtrayectoriaA}{C}{El actor ingresó una contraseña con un formato incorrecto}
	\UCpaso [\UCactor] Muestra el mensaje \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecto} indicando que la contraseña ingresada es incorrecta.
	\UCpaso Regresa al paso \ref{contra} de la Trayectoria Principal.
...
\begin{UCtrayectoriaA}{D}{El actor ingresó una confirmación de contraseña que no coincide con la contraseña nueva.}
	\UCpaso [\UCactor] Muestra el mensaje  \cdtIdRef {MSG24}{Validación de contraseña incorrecta} indicando que la confirmación de contraseña ingresada no coincide con la nueva contraseña.
