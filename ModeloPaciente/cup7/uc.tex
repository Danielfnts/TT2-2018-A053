\begin{UseCase}{CUP6}{Consultar Tratamiento}
    {
    	
    	Un paciente tendrá una lista con todos sus tratamientos. De esta manera sabrá cuantos y cuáles son sus tratamientos, su estado y la información de estos, como nombre de tratamiento, doctor que expidió, fecha de expedición y número de medicamentos
...
%--------------------------------------------------------
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Da clic sobre el ícono \textbf{Consultar Tratamientos} en la pantalla \cdtIdRef{IUP7}{Consultar Tratamiento}.
 	...
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP7}{Consultar Tratamiento}.\refTray{A}
 ...
 \begin{UCtrayectoriaA}{A}{El actor no cuenta con un tratamiento.}
 	\UCpaso Muestra el mensaje \cdtIdRef{MSG9}{No hay tratamientos} en la pantalla \cdtIdRef{IUP7}{Consultar Tratamiento}
