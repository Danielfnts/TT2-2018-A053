\begin{UseCase}{CUP15}{Agregar Auxiliar}
    {
   		Este caso de uso permite al \textbf{Paciente} ingresar los datos de un nuevo Auxiliar el cual estará a cargo de un tratamiento médico del paciente.
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Paciente}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Agregar Auxiliar.}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Agregar Auxiliar.}
	\UCitem{Entradas}{
		\begin{UClist} 
			...
			\UCli \textbf{Tratamientos}: Se seleccionan de una lista de checkbox
	\end{UClist}}
	\UCitem{Salidas}{Ninguna.}
	\UCitem{Precondiciones}{Ninguna.}
	\UCitem{Postcondiciones}{   
		{\bf Interna:} Registrará los datos del Auxiliar en la aplicación.
	}
	...
	\UCitem{Mensajes}{	
		...
		\UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \textbf{Agregar Nuevo Auxiliar} cuando el actor omitió un dato marcado como requerido.
		\UCli \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecto}: Se muestra en la pantalla \textbf{Agregar Nuevo Auxiliar} indicando que el correo electrónico y/o contraseña son incorrectos.
	}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el botón \textbf{Agregar Auxiliar} de la pantalla \textbf{Gestion Auxiliares}.
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP20}{Agregar Auxiliar}.
 	\UCpaso [\UCactor] Ingresa el nombre del auxiliar.
 	\UCpaso [\UCactor] Ingresa el apellido paterno del auxiliar.
 	\UCpaso [\UCactor] Ingresa el apellido materno del auxiliar.
 	\UCpaso [\UCactor] Ingresa el teléfono del auxiliar.
 	\UCpaso [\UCactor] Ingresa el correo electrónico del auxiliar.
 	\UCpaso [\UCactor] Selecciona los tratamientos con los que estará trabajando el auxiliar.
 	\UCpaso [\UCactor] Presiona el botón \textbf{Agregar Nuevo Auxiliar}.
 	\UCpaso Verifica que no haga falta ningún dato requerido con base en la regla de negocio \textbf{RN Datos Requeridos}.
 	\UCpaso Verifica que el correo electrónico cumpla con el formato correcto con base en la regla de negocio \textbf{RN12 Formato de Correo Electrónico}.
 	\UCpaso Muestra el mensaje \cdtIdRef{MSG1}{Operación Exitosa} en la pantalla \cdtIdRef{IUP22}{Consultar Auxiliar}.
