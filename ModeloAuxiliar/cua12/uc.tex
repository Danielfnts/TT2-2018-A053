\begin{UseCase}{CUA12}{Agregar Contacto de Emergencia}
    {
    	Este caso de uso permite al \textbf{Auxiliar} ingresar los datos de un nuevo contacto de emergencia para que éste pueda ser notificado en caso de que el actor no consuma algún medicamento de alta importancia.  
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Agregará al contacto de emergencia en la aplicación.
	}
	...
	\UCitem{Mensajes}{
	    ...
	    \UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Contactos de Emergencia} cuando se agregó el contacto de emergencia de manera exitosa.
		\UCli \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operación solicitada}: Se muestra en la pantalla \textbf{Agregar Nuevo Contacto de Emergencia} cuando el actor omitió un dato marcado como requerido.
		\UCli \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecto}: Se muestra en la pantalla \textbf{Agregar Nuevo Contacto de Emergencia} indicando que el correo electrónico y/o contraseña son incorrectos.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP24}{Agregar Contacto}.
 	...
 	\UCpaso [\UCactor] Presiona el botón \cdtButton{Agregar}. \refTray{A}
	\UCpaso Verifica que no haga falta ningún dato requerido con base en la regla de negocio \textbf{RN Datos Requeridos}. \refTray{B}
	\UCpaso Verifica que el correo electrónico cumpla con el formato correcto con base en la regla de negocio \textbf{RN Formato de Correo Electrónico}.\refTray{C}
	\UCpaso Muestra el mensaje \textbf{MSG1 Operación Exitosa} en la pantalla \cdtIdRef{IUP26}{Consultar Contacto}.
 ...
 \begin{UCtrayectoriaA}{A}{El actor desea cancelar la operación.}
   ...
   \UCpaso Regresa a la pantalla \cdtIdRef{IUP26}{Consultar Contacto}.
 \end{UCtrayectoriaA}
 
 \begin{UCtrayectoriaA}{B}{El actor no ingresó un dato requerido.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{Falta un dato requerido para efectuar la operaciónn solicitada} en la pantalla \textbf{Agregar Nuevo Contacto de Emergencia}.
 ...
 \begin{UCtrayectoriaA}{C}{El actor ingresó un correo electrónico y/o contraseña con un formato incorrecto.}
    \UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG3}{Correo electrónico y/o contraseña incorrecta} en la pantalla \textbf{Agregar Nuevo Contacto de Emergencia} indicando que el usuario y/o contraseña son incorrectos.
    \UCpaso[] Continúa con el paso \ref{datos} de la trayectoria principal.
 \end{UCtrayectoriaA} 
