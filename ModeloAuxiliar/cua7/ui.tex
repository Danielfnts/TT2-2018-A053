\subsection{IUA6 Consultar Tratamiento de Pacientes}
...
\subsubsection{Diseño}
    ...
    En la figura \ref{IUA6} se muestra la pantalla ``Consultar Tratamientos'', por medio de la cual se podrán consultar los tratamientos registrados en el sistema. \\
\newpage
    \IUfig[.3]{pantallas/consultarTratamientoP}{IUA6}{Consultar Tratamiento de Pacientes}
