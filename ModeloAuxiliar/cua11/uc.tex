\begin{UseCase}{CUA11}{Consultar Contacto de Emergencia}
    {
    	
    	Un contacto de emergencia es la persona a la cual se contactará cuando un \textbf{Paciente} no esté realizando la toma de un medicamento que tenga una clasificación \textbf{Importante}, es por eso que un auxiliar podrá visualizar la información de los contactos de emergencia.
    }
    \UCitem{Versión}{1.0}
...
{\cdtIdRef{CUA12}{Agregar Contactos de Emergencia}}
