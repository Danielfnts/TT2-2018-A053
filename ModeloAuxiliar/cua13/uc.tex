\begin{UseCase}{CUA13}{Eliminar Contacto de Emergencia}
    {
    	Este caso de uso permite al \textbf{Auxiliar} eliminar un contacto de emergencia en caso de que el actor no quiera que se le siga notificando a ese contacto de emergencia cuando no consuma algún medicamento de alta importancia. 
    ...
    \UCitem{Operación}{Eliminar Contacto de Emergencia}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Eliminar Contactos de Emergencia}
	\UCitem{Entradas}{Ninguna.}
	\UCitem{Salidas}{Ninguna.}
	\UCitem{Precondiciones}{Ninguna.}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} Eliminará el contacto de emergencia de la cuenta del paciente.
	}
    \UCitem{Reglas de negocio}{Ninguna.}
	\UCitem{Mensajes}{\begin{UClist}
	\UCli \cdtIdRef{MSG22}{Eliminar Elemento}: Se muestra en la pantalla \textbf{Contactos de Emergencia} cuando el actor solicita eliminar un contacto de emergencia
	\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Contactos de Emergencia} cuando se eliminó el contacto de emergencia de manera exitosa.
	\end{UClist}}
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el ícono \textbf{Eliminar Contacto de Emergencia} asociado al contacto de emergencia que desea eliminar en la pantalla \cdtIdRef{IUP26}{Consultar Contacto}.
 	\UCpaso Muestra el mensaje \cdtIdRef{MSG22}{Eliminar Elemento} en la pantalla \textbf{Contactos de Emergencia}.
 	\UCpaso [\UCactor] Confirma eliminar el contacto de emergencia a través del botón \textbf{Eliminar}.
 	\UCpaso Elimina el contacto de emergencia de la aplicación.
	\UCpaso Muestra el mensaje \textbf{MSG1 Operación Exitosa} en la pantalla \textbf{Contactos de Emergencia}.
    
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor desea cancelar la operación.}
    \UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \textbf{Cancelar} en el mensaje \cdtIdRef{MSG22}{Eliminar Elemento}.
   \UCpaso Muestra a la pantalla \textbf{Contactos de Emergencia}.
 \end{UCtrayectoriaA}
