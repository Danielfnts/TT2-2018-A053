\begin{UseCase}{CUA3}{Agregar Paciente}
    {
   		Este caso de uso permite al \textbf{Auxiliar} ingresar los datos de un nuevo Paciente al cual le podrá auxiliar con el seguimiento de su tratamiento médico.
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Agregar Paciente.}
	\UCitem{Entradas}{
		\begin{UClist} 
