\begin{UseCase}{CUA10}{Consultar Recordatorios}
    {
    	Un Auxiliar podrá consultar los recordatorios con los que cuente su paciente en ese momento, de esta manera podrá saber cuáles son las medicinas más próximas a tomar, saber su nombre y la dosis.
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar recordatorios.}
	\UCitem{Entradas}{
        Ninguna
    }
	\UCitem{Salidas}{
		\begin{UClist} 
			...
			\UCli Número de píldoras restantes.
	...
	\UCitem{Mensajes}{
	     ...
	     \cdtIdRef{MSG8}{No se pudieron obtener los datos}: Se muestra en la pantalla \textbf{Gestión notificaciones} cuando el actor omitió un dato marcado como requerido.
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el ícono \textbf{Consultar Recordatorios} en la pantalla \textbf{Gestión recordatorios}
 	...
 	\UCpaso Obtiene el número de píldoras restantes.
 	\UCpaso Obtiene el horario del recordatorio.
 	\UCpaso Ordena los recordatorios según el horario del recordatorio.
 	\UCpaso Muestra la pantalla \cdtIdRef{IUP18}{Consultar Recordatorios}
 	
     
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no tiene recordatorios.}
 	\UCpaso Muestra el mensaje \cdtIdRef{MSG25}{No hay recordatorios}.
