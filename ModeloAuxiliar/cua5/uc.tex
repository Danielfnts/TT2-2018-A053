\begin{UseCase}{CUA4}{Editar Paciente}
    {
    	Este caso de uso permite al \textbf{Auxiliar} editar los datos de un Paciente en caso de que haya registrado un dato incorrecto o desee actualizar su teléfono o correo electrónico.
    }
    \UCitem{Versión}{1.0}
