\begin{UseCase}{CUA5}{Eliminar Paciente}
    {
    	Este caso de uso permite al \textbf{Auxiliar} eliminar un paciente en caso de que el actor ya no tenga ningún tratamiento médico en estado \textbf{incompleto}. 
    }
    \UCitem{Versión}{1.0}
...
%--------------------------------------------------------
	...
	\UCitem{Salidas}{\begin{UClist} 
			\UCli \cdtIdRef{MSG}{Eliminar Elemento}: Se muestra en la pantalla \textbf{Gestión Pacientes} cuando el actor solicita eliminar un paciente.
