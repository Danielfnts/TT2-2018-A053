\begin{UseCase}{CUA15}{Consultar Alertas}
    {
    	Un Auxiliar debe de estár conciente de cuáles son los medicamentos que son de vital importancia que el Paciente deba consumir, es por eso que debe de contar con una visualización de estos.
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Auxiliar}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Consultar alertas}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Consultar alertas.}
	\UCitem{Entradas}{
        Ninguna
    }
 ...
 \begin{UCtrayectoria}
 	...
 	\UCpaso [\UCactor] Presiona el ícono \textbf{Consultar Alertas} en la pantalla \textbf{Gestión recordatorios}
