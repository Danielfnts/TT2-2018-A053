\begin{UseCase}{CUA7}{Agregar Tratamiento al Paciente}
    {
   		Este caso de uso permite al \textbf{Auxiliar} ingresar los datos de un tratamiento nuevo a un Paciente que ya esté asociado con su cuenta.
    }
    \UCitem{Versión}{1.0}
