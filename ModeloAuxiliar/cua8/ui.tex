\subsection{IUA7 Agregar Tratamiento al Paciente}
 
\subsubsection{Objetivo}

    Esta pantalla permite al actor agregar un nuevo tratamiento médico a la aplicación.

\subsubsection{Diseño}

    En la figura \ref{IUA7} se muestra la pantalla ``Agregar Nuevo Tratamiento'', por medio de la cual se podrá agregar un nuevo tratamiento médico a la aplicación. \\
\newpage
    \IUfig[.3]{pantallas/agregarTratamientoD}{IUA7}{Agregar Tratamiento al Paciente}
