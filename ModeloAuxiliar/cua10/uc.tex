\begin{UseCase}{CUA9}{Agregar Medicamento a Tratamiento del Paciente}
    {
   		Este caso de uso permite al \textbf{Auxiliar} ingresar los datos de un tratamiento nuevo a un Paciente que ya esté asociado con su cuenta y agregar los Medicamentos necesarios para este tratamiento..
    }
    \UCitem{Versión}{1.0}
    \UCccsection{Auxiliar}
    \UCitem{Autor}{Daniel Josue Fuentes Hernández}
    \UCccitem{Evaluador}{Victor Arquimedes Estrada Machuca}
    \UCitem{Operación}{Agregar Medicamento a Tratamiento.}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Agregar Medicamento a Tratamiento.}
	\UCitem{Entradas}{
		\begin{UClist} 
