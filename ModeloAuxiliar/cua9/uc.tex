\begin{UseCase}{CUA8}{Eliminar Tratamiento del Paciente}
    {
    	Este caso de uso permite al actor eliminar un tratamiento que se encuentre en estado \textbf{terminado}.
    ...
    \UCitem{Operación}{Eliminar Tratamiento de Pacientes}
...
%--------------------------------------------------------
	...
	\UCitem{Propósito}{Eliminar Tratamiento de Pacientes}
	\UCitem{Entradas}{
        Ninguna
   }
	\UCitem{Salidas}{Ninguna.}
	\UCitem{Precondiciones}{
		{\bf Interna:} El tratamiento debe estár registrado en el sistema.
		}
	\UCitem{Postcondiciones}{
	    {\bf Interna:} El tratamiento será eliminado del sistema.	
	}
	...
	\UCitem{Mensajes}{
	    \begin{UClist}
	    \UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \textbf{Información del Paciente} cuando se inicio la sesión de manera exitosa.	
 ...
 \begin{UCtrayectoria}
	 ...
	 \UCpaso [\UCactor] Selecciona un \textbf{Paciente} de la pantalla \textbf{Gestión Pacientes}
 
 	% 	\cdtIdRef{IUP7}{Consultar Tratamiento}.
 	\UCpaso	Obtiene la información de los pacientes.
 	...
 	\UCpaso [\UCactor] Da clic en el botón \textbf{Eliminar Tratamiento}.
 	\UCpaso Muestra el mensaje \textbf{MSG}{Eliminar Tratamiento}.
 	
% 	\textbf{MSG16}{Eliminar Doctor}.
 	\UCpaso [\UCactor] Presiona el botón \cdtButton{Eliminar}.\refTray{A}
 	\UCpaso Muestra el mensaje \textbf{MSG}{El tratamiento se eliminará del sistema}
% 	\textbf{MSG17}{Tratamiento pasaran a estado incompleto}
 	\UCpaso [\UCactor] Presiona el botón \cdtButton{Aceptar}.\refTray{A}
 	\UCpaso Elimina el tratamiento.
 	\UCpaso Muestra el mensaje \textbf{MSG1}{Operacion correcta} en la pantalla \textbf{Gestión Paciente} 	
% 	\cdtIdRef{IUP15}{Consultar Doctor}.	
 	
    
 \end{UCtrayectoria}

 \begin{UCtrayectoriaA}{A}{El actor no quiere eliminar al tratamiento.}
